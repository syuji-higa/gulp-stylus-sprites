var File, basename, defOpts, defaults, defaultsDeep, dirname, join, recursive, ref, ref1, spritesmith, through;
through = require('through2');
File = require('gulp-util').File;
ref = require('path'), join = ref.join, dirname = ref.dirname, basename = ref.basename;
ref1 = require('lodash'), defaults = ref1.defaults, defaultsDeep = ref1.defaultsDeep;
...
module.exports = function(opts) {
  var createCss, cssHash, files, flush, folderInFileCount, imgSrcBase, mixin, ref2, spritePath, spritesmithOpts, stylusFileName, transform;
  if (opts == null) {
    opts = {};
  }
