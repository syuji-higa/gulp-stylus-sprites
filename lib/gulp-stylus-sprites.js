var File, PLUGIN_NAME, PluginError, defOpts, defaults, dirname, filesDataCache, forEach, join, map, merge, readFileSync, readdirSync, ref, ref1, ref2, ref3, relative, some, spritesmith, through;
through = require('through2');
ref = require('gulp-util'), File = ref.File, PluginError = ref.PluginError;
ref1 = require('path'), join = ref1.join, dirname = ref1.dirname, relative = ref1.relative;
ref2 = require('lodash'), forEach = ref2.forEach, map = ref2.map, defaults = ref2.defaults, some = ref2.some, merge = ref2.merge;
